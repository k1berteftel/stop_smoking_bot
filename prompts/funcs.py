...
abstract_prompt = """Сократи диалог до основных тезисов и выводов,сохранив всю важную информацию. Убедись, что в конспекте отражены ключевые моменты, решения, договоренности, результаты тестов и опросов.  Используй нейтральный тон и структурированный формат.
...
На основе твоего каждого вопроса теста или анкеты и ответа пользователя, тебе надо составить одно предложение отображающее суть.
Пример 1:
...
Такие записи хранятся и больше не корректируются. 
            """
